...
LUA_SHA1 = get_hash(os.path.join(CWD, 'yahoomaps.lua'))
...
project = Project(
    ...
    project_html="""
        ...
        <h2>maps.yahoo.com <span class="links"><a href="https://maps.yahoo.com/">Website</a> &middot; <a href="http://tracker.archiveteam.org/yahoomaps/">Leaderboard</a></span></h2>
        <p>Grabbing all tiles from Yahoo! Maps.</p>
    """,
    utc_deadline=datetime.datetime(2015, 6, 30, 23, 59, 0)
)
...
pipeline = Pipeline(
    ...
    GetItemFromTracker("http://%s/%s" % (TRACKER_HOST, TRACKER_ID), downloader,
        VERSION),
    PrepareDirectories(warc_prefix="yahoomaps"),
    WgetDownload(
        WgetArgs(),
        max_tries=2,
